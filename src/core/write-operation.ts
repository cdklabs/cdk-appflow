...
export class WriteOperation {
  public static insert(ids?: string[]): WriteOperation {
    return new WriteOperation(WriteOperationType.INSERT, ids);
  }
  public static delete(ids?: string[]): WriteOperation {
    return new WriteOperation(WriteOperationType.DELETE, ids);
  }
  public static update(ids?: string[]): WriteOperation {
    return new WriteOperation(WriteOperationType.UPDATE, ids);
  }
  public static upsert(ids?: string[]): WriteOperation {
