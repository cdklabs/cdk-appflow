...
describe("MicrosoftSharepointOnlineSource", () => {
  test("Source with only connector name", () => {
    ...
    const source = new MicrosoftSharepointOnlineSource({
      profile:
        MicrosoftSharepointOnlineConnectorProfile.fromConnectionProfileName(
          stack,
          "TestProfile",
          "dummy-profile",
        ),
      object: {
        ...
        entities: [
          "drives/b!fcPDltwTLSougEJuDFjE?U5qHuXbkzlvSaA5oNoMW4tB0y6mebcx9m-ckwA9KtKE",
        ],
      },
      apiVersion: MicrosoftSharepointOnlineApiVersion.V1,
    });

    const expectedConnectorType =
      MicrosoftSharepointOnlineConnectorType.instance;
    ...
    Template.fromStack(stack).hasResourceProperties("AWS::AppFlow::Flow", {
      ...
      SourceFlowConfig: {
        ...
        SourceConnectorProperties: {
          CustomConnector: {
            EntityName:
              "sites/dummysite.sharepoint.com,3f42g340-bc23-4a31-b7e5-722e57c39cb8,5bbc39fb-2b17-423b-a007-40ca508389a5",
            CustomProperties: {
              subEntities:
                '["drives/b!fcPDltwTLSougEJuDFjE?U5qHuXbkzlvSaA5oNoMW4tB0y6mebcx9m-ckwA9KtKE"]',
            },
