...
import { OnDemandFlow, S3Source, S3Destination, Mapping } from "../../../src";
...
describe("OnDemandFlow metrics", () => {
  test("default", () => {
    ...
    addAlarmForMetric(
      stack,
      flow.metricFlowExecutionsStarted(),
      "FlowExecutionsStartedAlarm",
    );
    addAlarmForMetric(
      stack,
      flow.metricFlowExecutionsFailed(),
      "FlowExecutionsFailedAlarm",
    );
    addAlarmForMetric(
      stack,
      flow.metricFlowExecutionsSucceeded(),
      "FlowxecutionsSucceededAlarm",
    );
    addAlarmForMetric(
      stack,
      flow.metricFlowExecutionTime(),
      "FlowExecutionTimeAlarm",
    );
    addAlarmForMetric(
      stack,
      flow.metricFlowExecutionRecordsProcessed(),
      "FlowExecutionRecordsProcessedAlarm",
    );
